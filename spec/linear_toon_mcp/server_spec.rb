  ...
  describe "tools/list" do
    ...
    it "lists all tools" do
      expect(result[:result][:tools]).to contain_exactly(
        ...
        include(name: "list_users", description: "List users in the workspace"),
        include(name: "list_issue_labels", description: "List issue labels in the workspace"),
        include(name: "list_projects", description: "List projects in the workspace"),
